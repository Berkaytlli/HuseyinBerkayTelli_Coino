    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProducts_Users_UserAppId",
                        column: x => x.UserAppId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 25, 4, 2, 2, 555, DateTimeKind.Local).AddTicks(2842), null, null, null, "Member", null, null });

            migrationBuilder.InsertData(
                table: "OperationClaims",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedAt", "DeletedBy", "Name", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 2, new DateTime(2023, 1, 25, 4, 2, 2, 555, DateTimeKind.Local).AddTicks(2853), null, null, null, "Admin", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_UserAppId",
                table: "OrderProducts",
                column: "UserAppId");
